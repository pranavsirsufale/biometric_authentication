...
const register = async (req, res) => {
  try {
    ...
    const { username, email, phone, password , finger_image , finger_key } = req.body;
...
export { home, register, login, user , biometricLogin };
